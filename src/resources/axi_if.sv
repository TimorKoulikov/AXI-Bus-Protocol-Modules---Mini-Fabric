...
(
	...
	modport slave_if (
		...
		input  ARADDR, ARLEN, ARSIZE, ARBURST, ARID, ARVALID, ARLOCK, ARCACHE, ARPROT, ARQOS,
		output ARREADY,
	...
	modport master_if (
		...
		output ARADDR, ARLEN, ARSIZE, ARBURST, ARID, ARVALID, ARLOCK, ARCACHE, ARPROT, ARQOS,
		input  ARREADY,
